...
internal class RealSubSamplingImageState(
  ...
  private val tileGrid by derivedStateOf {
    if (isReadyToBeDisplayed) {
      val customTileSize = com.pixel.gallery.data.repository.LargeImagePerformanceConfig.tileSize
      ImageRegionTileGrid.generate(
        viewportSize = viewportSize!!,
        unscaledImageSize = imageSize!!,
        minTileSize = androidx.compose.ui.unit.IntSize(customTileSize, customTileSize)
      )
    } else null
  }
